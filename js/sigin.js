...
function logSubmit() {
        ...
        var password = document0.getElementById('password');
        ...
        if (namecheck.test(fname.value) || namecheck == ''){
           ...
           document.getElementById ('frameerror').style.fontsize = '16px'
           document.getElementById('frameerror').style.color ='red'
